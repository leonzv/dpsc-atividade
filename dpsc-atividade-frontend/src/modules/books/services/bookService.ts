...
import { Book, BookRepository, CreateBookDTO, UpdateBookDTO } from '../types/book.types'

class BookService implements BookRepository {
  async getAll(params?: { page: number; perPage: number; search?: string }): Promise<PaginatedResponse<Book>> {
